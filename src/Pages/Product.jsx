            ...
            <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
                ...
                <div className='flex-1 '>
                        ...
                        <div className='flex gap-2'>
                            {productData.sizes.map((item, index) => (
                                <button
                                    ...
                                    className={`border py-2 px-4 bg-gray-400 ${item === size ? 'border-orange-700' : ''}`}
                                    key={index}>
                                    {item}
                                </button>
                            ))}
                    ...
                    <div className="flex gap-4 mt-6">
                        ...
                        <button 
                            onClick={() => navigate('/cart')}  // 🚀 Navigates to cart page
                            className='bg-orange-600 text-white px-8 py-3 active:bg-orange-700'>
                            GO TO CART
                        </button>
                    </div>
